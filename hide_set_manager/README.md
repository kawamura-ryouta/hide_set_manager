...
### 2. 非表示セットの登録（＋）
<div style="max-width: 800px; margin: auto;">
  <img src="../README_picture/register_set.png" style="width: 100%;">
</div>
...
**差分が発生する例**
<div style="max-width: 800px; margin: auto;">
  <img src="../README_picture/sync_case.png" style="width: 100%;">
</div>

**⚠ 差分あり（未同期）**
<div style="max-width: 800px; margin: auto;">
  <img src="../README_picture/sync_warning.png" style="width: 100%;">
</div>

**✓ 同期後（解決）**
<div style="max-width: 800px; margin: auto;">
  <img src="../README_picture/sync_resolved.png" style="width: 100%;">
</div>
...
### 5. JSON Export
<div style="max-width: 800px; margin: auto;">
  <img src="../README_picture/json_export.png" style="width: 100%;">
</div>
...
### 方法①：配布用 ZIP からインストール（推奨）

1. GitHub の **Releases** ページを開きます  
2. Assets にある **`hide_set_manager.zip`** をダウンロードします  
3. Blender を起動し、  
   **編集 → プリファレンス → アドオン → インストール** を選択します  
4. ダウンロードした `hide_set_manager.zip` を指定します  
5. アドオン一覧に表示された **Hide Set Manager** を有効化します  

### 確認
- 3D ビューポートのサイドバー（N キー）に  
  **「非表示セット」パネル**が表示されれば成功です
